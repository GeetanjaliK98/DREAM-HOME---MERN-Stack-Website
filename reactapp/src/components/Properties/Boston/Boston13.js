...
function Food1Desc  (props) {
  ...
  if(!isLoaded) {
    ...
    <Card className="desccard">
        <Card.Img className="descimg" variant="top" src={process.env.PUBLIC_URL + "/Assets/house1.jpg"} />
        <Card.Body>
          <Card.Text>
          A 2500sqft spacious house with all amenities included
          </Card.Text>
        </Card.Body>
    </Card>
    </div>
